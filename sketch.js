...
function draw() {
  ...
  if (Matter.Detector.canCollide(player.body, object1.body)) {
    text(
      "A strange, yet beautiful, luminecent plant that lights the way in the darkness and illuminates the unknown, those who eat its fruit are said to be able to glow like the moon",
      200,
      200
    );
...
function getBackgroundImage(bgState) {
  switch (bgState) {
    case "Forest":
      bgImage = Forest1;
      break;
